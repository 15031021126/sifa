...
public abstract class EaseChatRow extends LinearLayout {
    ...
    public EaseChatRow(Context context, EMMessage message, int position, BaseAdapter adapter) {
        ...
        mListener = (EaseConversationAdapter.AvatarAndNameListener) context;
    ...
    EaseConversationAdapter.AvatarAndNameListener mListener;
    ...
    private void setUpBaseView() {
        ...
        if(userAvatarView != null) {
            ...
            if (message.direct() == Direct.SEND) {
                ...
                mListener.setAvatarAndName(EMClient.getInstance().getCurrentUser(), usernickView, userAvatarView);
            } else {
                EaseUserUtils.setUserAvatar(context, message.getFrom(), userAvatarView);
                EaseUserUtils.setUserNick(message.getFrom(), usernickView);
                mListener.setAvatarAndName(message.getFrom(), usernickView, userAvatarView);
            }
        }
