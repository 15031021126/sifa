...
public class EnforcementFragment extends BaseFragment {
    ...
    Unbinder unbinder;
    public EnforcementFragment( ) {

    }
    public static EnforcementFragment newInstance() {
...
//                mechismPeopleAdapter.addList(list);
            }
        });
    }
