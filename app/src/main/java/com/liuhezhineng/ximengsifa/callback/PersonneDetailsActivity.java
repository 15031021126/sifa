 ...
 */
public class PersonneDetailsActivity extends BaseActivity {
    ...
    MechanismsubjectBean.BodyBean.ListBean   mBean;
    private ArrayList<PersonInsDetailsBean> mList;
    public static void actionStart(Context context,
                                   MechanismsubjectBean.BodyBean.ListBean   bean, String perInsFlag) {
        Intent intent = new Intent(context, PersonneDetailsActivity.class);
    ...
    protected void initView() {
        ...
        mBean = (  MechanismsubjectBean.BodyBean.ListBean ) getIntent().getParcelableExtra(Constant.BEAN);
            ...
            if (ContextCompat.checkSelfPermission(this, Permission.WRITE_EXTERNAL_STORAGE)
                ...
                AndPermission.with(this)
                        ...
                        .onDenied(new Action<List<String>>() {
                            @Override
                            public void onAction(List<String> data) {
                                Toast.makeText(PersonneDetailsActivity.this,
...
//                .centerCrop(Gravity.TOP)
                .into(mIvAvatar);
        mTvPhone.setText(mBean.getPhone());
    }
...
//                MyConsultationActivity.actionStart(mActivity, mBean.getId());
    ...
    private void addData() {
        String[] keyArr;
        String[] valueArr;
        keyArr = new String[]{"部门简称", "负责人","统一社会信用代码",
                "上级所属部门",
                "上级指导部门", "文书号部分简称",
                "部门类型",
        };
        valueArr = new String[]{mBean.getName(), mBean.getManager(),  mBean.getCreditcode(),
                mBean.getSuperiorOffice(),
                mBean.getGuidanceOffice(), mBean.getDocumentName(),
                mBean.getOfficeTypeDesc(),
        };
