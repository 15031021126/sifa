 ...
 * @description 法援审批
 */
public class AReviewActivity extends BaseLegalAidActivity {
    ...
    protected void initView() {
        ...
        btnWorkflow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NewWorkflowActivity.actionStart(AReviewActivity.this, mBusinessBean,mBaseBusinessBean);
            }
        });
    }
    public static void actionStart(Context context, BusinessBean businessBean) {
        Intent intent = new Intent(context, AReviewActivity.class);
    ...
    @OnClick({R.id.btn_no, R.id.btn_yes,R.id.tv_wenhua,R.id.tv_renqun,R.id.tv_biaozhun,R.id.tv_case
            ,R.id.tv_matters,R.id.tv_review_data,R.id.tv_matters_stage
    })
    ...
    private String getQueryStr() {
        ...
        mLegalAidWorkflow.setFyOpinion(etExaminationOpinion.getText().toString().trim());//fyOpinion  etExaminationOpinion
        createFrom();
        LogUtils.logi("2313132",new Gson().toJson(mLegalAidWorkflow).toString());
