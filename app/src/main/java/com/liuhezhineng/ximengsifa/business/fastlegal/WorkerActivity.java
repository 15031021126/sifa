 ...
 * @description 快速申请
 */
public class WorkerActivity extends BaseBusinessActivity implements AudioRecordButton.OnAudioFinishRecordListener {
    ...
    @BindView(R.id.tv_is_transferPenalty)
     ...
     */
    String yesOrNoFlag;
    @BindView(R.id.tv_et_address)
    TextView tvEtAddress;
    ...
    protected void loadUserInfo() {
        ...
        mTvStaffOffice.setText(user.getOffice().getName());
        mBean.setStaffOffice(user.getOffice());
...
//        mTvCaseArea.setText(county.getName());
    ...
    @OnClick({R.id.iv_voice_input,
            ...
            R.id.tv_commit, R.id.ll_case_data,
            R.id.tv_is_transferPenalty, R.id.tv_is_Petition, R.id.tv_is_affect_stability,
            R.id.tv_case_rank})
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.tv_case_rank:
                ...
                break;
            case R.id.tv_is_transferPenalty:
            ...
            case R.id.tv_commit:
                if (checkInput()) {
                    ...
                    mBean.setPersonnelType("1");
                    mBean.setCaseTime(tvCaseData.getText().toString().trim());
                    mBean.setCaseAddress(tvEtAddress.getText().toString().trim());
    ...
    private void showDataPickerView() {
        ...
        birthdayPickerView = new TimePickerBuilder(mActivity, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {
                Log.i("qingfeng", "updateUser: " + date.toString());
    ...
    private boolean checkInput() {
        ...
        tvetaddress  =tvEtAddress.getText().toString().trim();
        casedata=tvCaseData.getText().toString().trim();
        ...
        if (TextUtils.isEmpty(accuserPhone)
            ...
            return false;
        } else if (TextUtils.isEmpty(tvetaddress)) {
            ToastUtils.showLong("案发地址不能为空");
            return false;
