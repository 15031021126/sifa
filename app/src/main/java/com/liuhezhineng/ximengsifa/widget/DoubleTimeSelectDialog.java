...
//        mBeginTimeTv = (TextView) findViewById(R.roomId.tv_tclBeginTime);
//        mEndTimeTv = (TextView) findViewById(R.roomId.tv_tclEndTime);
//
//        findViewById(R.roomId.tv_tclCancel).setOnClickListener(this);
//        findViewById(R.roomId.tv_tclOk).setOnClickListener(this);
...
//        switch (v.getId()) {
//            case R.roomId.tv_tclBeginTime:
//                mTimeType = TIME_TYPE.TYPE_START;
//                init(mSelectStartTime, false);
////                mTimeContainerLl.setBackgroundResource(R.mipmap.begin_time_bg);
//                break;
//            case R.roomId.tv_tclEndTime:
//                mTimeType = TIME_TYPE.TYPE_END;
//                init(mSelectEndTime, false);
////                mTimeContainerLl.setBackgroundResource(R.mipmap.end_time_bg);
//                break;
//            case R.roomId.tv_tclCancel:
//                this.dismiss();
//
//                break;
//            case R.roomId.tv_tclOk:
//                SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd", Locale.CHINA);
//                try {
//                    if (sdf.parse(mSelectStartTime).getSeconds() > sdf.parse(mSelectEndTime).getSeconds()) {
...
//        }
//
//        mYearView = (WheelView) findViewById(R.roomId.year);
//        mMonthView = (WheelView) findViewById(R.roomId.month);
//        mDayView = (WheelView) findViewById(R.roomId.day);
//        mHourView = (WheelView) findViewById(R.roomId.hour);
//        mMinuteView = (WheelView) findViewById(R.roomId.minute);
//
//        if (!isShowHour) {
...
//
//        /* 年，月，日，时，分 等单位，和值同在 */
//        findViewById(R.roomId.tv_yearUnit).setVisibility(mYearView.getVisibility());
//
//        findViewById(R.roomId.tv_monthUnit).setVisibility(mMonthView.getVisibility());
//
//        findViewById(R.roomId.tv_dayUnit).setVisibility(mDayView.getVisibility());
//        findViewById(R.roomId.v_dayAndMinute).setVisibility(isShowHour ? View.VISIBLE : View.GONE);
//
//        findViewById(R.roomId.tv_hourUnit).setVisibility(mHourView.getVisibility());
//
//        findViewById(R.roomId.tv_minuteUnit).setVisibility(mMinuteView.getVisibility());
//
//        initDatePicker();
//
...
//            } else {
//	            if (((mYearView.getCurrentItem() + START_YEAR) % 4 == 0
//		            && (mYearView.getCurrentItem() + START_YEAR) % 100 != 0)
